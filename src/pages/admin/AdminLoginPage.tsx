...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // After sign in, the onAuthStateChange in AuthContext will fetch the profile.
      // We need to wait for the profile to be updated and check if it's an admin.
      // But typically, the useEffect above will handle redirection once the context updates.
